...
VALUES
  (1, 'AI Starter Engine', 'Perfect entry-level AI machine for beginners. Features blue holographic displays and smart learning algorithms.', 2500, 0.3600, 900, 27000, '["Smart Learning AI","Blue Holographic Display","Auto-Optimization","24/7 Operation","Beginner Friendly"]'::jsonb, NULL, 'blue holographic AI starter engine', 'blue-cyan', true, true),
  (2, 'Smart Gaming Engine', 'Advanced purple-themed gaming AI with enhanced processing power.', 5000, 0.3300, 1650, 49500, '["Purple Smart Interface","Enhanced Processing","Gaming Optimization","Ad Targeting AI","Consistent Earnings"]'::jsonb, NULL, 'purple smart gaming AI engine', 'purple-pink', true, true),
  (3, 'Quantum Processor', 'Green quantum-powered AI machine with advanced neural networks.', 10000, 0.3500, 3500, 105000, '["Quantum Processing","Green Energy Core","Neural Networks","Multi-Stream Revenue","Advanced Analytics"]'::jsonb, NULL, 'green quantum AI processor', 'green-emerald', true, true),
  (4, 'Neural Maximizer', 'Orange-themed neural AI maximizer with deep learning capabilities.', 15000, 0.3333, 5000, 150000, '["Deep Learning AI","Orange Neural Core","Predictive Algorithms","Engagement Maximizer","Revenue Optimization"]'::jsonb, NULL, 'orange neural AI maximizer', 'orange-red', true, true),
  (5, 'Hyper Intelligence', 'Red-powered hyper-intelligent AI system with advanced machine learning.', 25000, 0.3333, 8333, 250000, '["Hyper Intelligence","Red Power Core","Market Analysis","Premium Earnings","Sophisticated AI"]'::jsonb, NULL, 'red hyper intelligence AI system', 'orange-red', true, true),
  (6, 'Elite Matrix', 'Golden elite-class AI matrix with supreme processing power.', 50000, 0.3333, 16666, 500000, '["Elite Class AI","Golden Matrix Core","Supreme Processing","Maximum Revenue","Professional Grade"]'::jsonb, NULL, 'gold elite AI matrix machine', 'orange-red', true, true),
  (7, 'Omega Core', 'Cosmic silver omega-class AI core with unlimited potential.', 100000, 0.3333, 33333, 1000000, '["Omega Class AI","Cosmic Silver Core","Unlimited Potential","Revolutionary Tech","Coming Soon"]'::jsonb, NULL, 'silver cosmic omega AI core', 'blue-cyan', true, true),
  (8, 'Genesis Machine', 'Divine white and gold genesis-class AI machine. The ultimate AI earning system.', 150000, 0.3333, 50000, 1500000, '["Genesis Class AI","Divine Gold Core","Godlike Processing","Ultimate System","Future Technology"]'::jsonb, NULL, 'white gold genesis AI machine', 'green-emerald', true, true)
